...
2. Edit the [config/config.js](https://github.com/dikology/portfolio/blob/master/config/config.js) file. Replace [config/profile.png](https://github.com/dikology/portfolio/blob/master/config/profile.png) with your image. 
...
>Note: You need to replace `<your-username>` with your username. To add CNAME for custom domain, see [scripts/cname.js](https://github.com/dikology/portfolio/blob/master/scripts/cname.js)
